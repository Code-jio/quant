...
class BacktestEngine:
    ...
    def __init__(self, config: BacktestConfig):
        ...
        self.equity_curve: Dict[datetime, Dict] = {}
    ...
    def _execute_order(self, order: Order, signal: Signal):
        """执行订单"""
    ...
    def _open_position(self, symbol: str, price: float, volume: int, direction: Direction):
        """开仓"""
    ...
    def _close_position(self, symbol: str, price: float, volume: int, direction: Direction):
        """平仓"""
        commission = price * volume * self.config.commission_rate
    ...
    def _create_trade(self, symbol: str, price: float, volume: int, 
                     direction: Direction, commission: float) -> Trade:
        """创建成交记录"""
    ...
    def _update_positions(self, bars: Dict[str, pd.Series]):
        """更新持仓盯市"""
    ...
    def _record_equity(self, date: datetime, bars: Dict[str, pd.Series]):
        """记录权益曲线"""
        try:
    ...
    def _calculate_result(self, dates: List[datetime]):
        """计算回测指标"""
        try:
